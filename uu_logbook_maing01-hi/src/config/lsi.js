const Lsi = {
  appName: {
    cs: "Aplikace uuLogbook",
    en: "Application uuLogbook",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci uuLogbook",
      en: "About application uuLogbook",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuLogbook.",
      en: "You can buy your own uuLogbook.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuLogbook.",
      en: "You don't have rights to initialize this uuLogbook.",
    },
  },
